...
export const optimizePrompt = async (promptId: string, strategy: PromptOptimizationStrategyType): Promise<{ success: boolean; data?: unknown; error?: string }> => {
  try {
...
export const evaluatePrompt = async (promptId: string, evaluationResult: PromptEvaluationResult): Promise<{ success: boolean; data?: unknown; error?: string }> => {
  try {
