...
import { sensitiveOperationsRateLimit } from '../middleware/rateLimiting';

const router = Router();
const promptService = new PromptService();

// GET /api/prompts
router.get('/', validatePagination, async (_req: Request, res: Response) => {
...
router.post('/', 
  validatePromptCreation,
  auditAction('prompt_create', 'prompts'),
...
router.post('/:id/versions', 
  validateId(),
  validatePromptCreation,
  auditAction('prompt_version_create', 'prompts'),
  async (req: Request, res: Response) => {
...
router.post('/:id/rollback/:versionId', 
  ...
  auditAction('prompt_rollback', 'prompts'),
  async (req: Request, res: Response) => {
...
router.patch('/:id', 
  validatePromptUpdate,
  auditAction('prompt_update', 'prompts'),
  async (req: Request, res: Response) => {
...
router.delete('/:id', 
  ...
  auditAction('prompt_delete', 'prompts'),
  async (req: Request, res: Response) => {
